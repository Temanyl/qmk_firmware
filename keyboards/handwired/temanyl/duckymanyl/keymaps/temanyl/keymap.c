...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT_100_percent(
        ...
        KC_LCTL,  KC_LWIN,  KC_LALT,                                KC_SPC,                                 KC_RALT,  KC_RWIN, MO(_CONTROL), KC_RCTL, KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,              KC_PDOT
    ),
    [_CONTROL] = LAYOUT_100_percent(
            ...
            _______,    _______,     _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______,    _______,    KC_MPLY,    KC_MPRV,    KC_MNXT,    _______,    _______,    _______,    _______,
            _______,    _______,     _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______,    _______,    KC_MUTE,    KC_VOLD,    KC_VOLU,    _______,    _______,    _______,    _______,
