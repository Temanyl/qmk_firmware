...
qk_tap_dance_action_t tap_dance_actions[] = {
    [TD_Q]   = ACTION_TAP_DANCE_FN(td_q_esc_emoji_reset),
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC_COLEMAK_DH] = LAYOUT_ortho_3x10_4_10(
         TD(TD_Q),  KC_W,           KC_F,           KC_P,           KC_B,           KC_J,       KC_L,            KC_U,           KC_Y,           LT(0,KC_SCLN),
         ...
         KC_Z,      KC_X,           KC_C,           KC_D,           KC_V,           KC_K,       KC_H,            KC_COMMA,       KC_DOT,         KC_SLSH,
                                                    KC_LSFT,        KC_SPC,         KC_BSPC,    TD(TD_LAYER_NAV_NUM),
        KC_A,       KC_R,           KC_S,           KC_T,           KC_G,           KC_A,       KC_R,           KC_S,            KC_T,           KC_G
     ),
    [_MAC_CODE] = LAYOUT_ortho_3x10_4_10(
        ...
        KC_CIRC, KC_PLUS, KC_ASTR, KC_LBRC, KC_RBRC,        KC_TILDE, KC_DLR,  KC_PERC, KC_HASH, RSFT_T(KC_BSLS),
                            TD(TD_LAYER_DEFAULT_SHIFT), KC_SPC,        KC_BSPC,  TO(_MAC_NAV),
        KC_NO,      KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,      KC_NO,          KC_NO,          KC_NO,          KC_NO
    ),
    [_MAC_NAV] = LAYOUT_ortho_3x10_4_10(
        ...
        KC_NO,   KC_MS_L, KC_MS_D, KC_MS_R, KC_MPRV,        KC_VOLD, KC_NO,   KC_NO,    TO(_MAC_COLEMAK_DH),   TO(_MAC_QWERTY),
                              TD(TD_LAYER_DEFAULT_SHIFT), KC_SPC,          KC_BSPC, KC_NO,
        KC_NO,      KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,      KC_NO,          KC_NO,          KC_NO,          KC_NO
    ),
    [_MAC_NUM] = LAYOUT_ortho_3x10_4_10(
    ...
    [_MAC_QWERTY] = LAYOUT_ortho_3x10_4_10(
